...
import { Sex, Species, type SurgeryCase, type Task } from "../../../backend";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <Label htmlFor="edit-presentingComplaint">
                ...
                return (
                  ...
                  >
                    <Checkbox
                      ...
                      checked={isSelected}
                      onCheckedChange={() =>
                        toggleTaskSelected(item.selectedField)
                      }
                    />
                    <Label
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={updateCase.isPending || !arrivalDate}
            >
