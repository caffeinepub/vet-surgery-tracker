...
export const SORT_OPTIONS = [
  {
    value: "arrival-date-newest" as const,
    label: "Arrival Date (Newest First)",
  },
  {
    value: "arrival-date-oldest" as const,
...
export function sortCases(
  ...
  switch (sortOption) {
    ...
    case "open-tasks-most":
      return sorted.sort(
        (a, b) => getRemainingTaskCount(b) - getRemainingTaskCount(a),
      );
    case "open-tasks-fewest":
      return sorted.sort(
        (a, b) => getRemainingTaskCount(a) - getRemainingTaskCount(b),
      );
    default:
      return sorted;
  }
